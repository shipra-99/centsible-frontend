...
import avt30 from './../../../images/avatar/30.png';
import dot from './../../../images/dual-dot.png';
			...
			<div className="row page-titles mx-0">
				<div className="col-sm-6 p-0">
					<div className="welcome-text">
						<h2 className="text-black font-w600 mb-0">Transactions Details</h2>
					</div>
				</div>
				<div className="col-sm-6 p-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
					<ol className="breadcrumb">
						<li className="breadcrumb-item active"><Link to={"#"}>Transactions</Link></li>
						<li className="breadcrumb-item"><Link to={"#"}>#123412451</Link></li>
					</ol>
				</div>
			</div>
			<div className="row">
							...
							<div className="card">
								<div className="card-header d-sm-flex d-block border-0 pb-0">
									<div className="me-auto mb-sm-0 mb-3">
										...
										<span className="fs-34 text-black font-w600">#00123521</span>
									</div>
									<div>
										<Link to={"#"} className="btn btn-outline-primary btn-rounded me-3 mb-sm-0 mb-2"><i className="las la-print me-3 scale5"></i>Print</Link>
										<Link to={"#"} className="btn btn-primary btn-rounded mb-sm-0 mb-2"><i className="las la-download scale5 me-3"></i>Download Report</Link>
									</div>
								</div>
								<div className="card-body border-bottom">
									<div className="d-flex flex-wrap mb-sm-2 justify-content-between">
										<div className="pr-3 mb-3">
											...
											<span className="text-black fs-18 font-w500">MasterCard 404</span>
										</div>
										<div className="pr-3 mb-3">
											<p className="fs-14 mb-1">Invoice Date</p>
											<span className="text-black fs-18 font-w500">April 29, 2020</span>
										</div>
										<div className="pr-3 mb-3">
											<p className="fs-14 mb-1">Due Date</p>
											<span className="text-black fs-18 font-w500">June 5, 2020</span>
										</div>
										<div className="mb-3">
											<p className="fs-14 mb-1">Date Paid</p>
											<span className="text-black fs-18 font-w500">June 4, 2020</span>
										</div>
									</div>
									<div className="p-3 bgl-dark rounded fs-14 d-flex">
										<svg className="me-3 min-w24" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
								...
								<div className="card-body">
									...
									<div className="d-sm-flex d-block">
										<div className="d-flex me-auto mb-sm-0 mb-3 align-items-center">
											<img src={avt30} alt="" className="me-3 rounded-circle" width="85" />
											<div>
												<h3 className="fs-24 text-black font-w600">Samuel Bro</h3>
										...
										<div className="d-flex align-items-center p-3 rounded border border-primary">
											...
											<div>
												<p className="text-primary fs-14 mb-1">Telepon</p>
												<span className="text-primary font-w600">+91 123-456-7890</span>
											</div>
										</div>
									</div>
								</div>
				...
				<div className="col-xl-4">
					<div className="row">
						<div className="col-xl-12 col-lg-6 col-md-12 mb-5">
						...
						<div className="col-xl-12 col-lg-6 col-md-12">
							<div className="card">
								<div className="card-header border-0 pb-0">
									<div>
										<h4 className="fs-20 text-black">Statistic</h4>
